...
#define LEDCOUNT   102     //  Number of LEDs used for boblight
...
// 0x65 = nbLed - 1 | 0x30 = Xor calc -> 55 xor 65
const char prefix[] = {0x41, 0x64, 0x61, 0x00, 0x65, 0x30};  // Start prefix ADA
